        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfSeatsPerRow = table.Column<int>(type: "int", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Hall__7E60E21495C08AC1", x => x.HallId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TheaterInfoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TheaterI__814E88BD6D5EB47F", x => x.TheaterInfoId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Purchase__6B0A6BBED4913846", x => x.PurchaseId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Notifica__20CF2E12A19052D9", x => x.NotificationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowGenreId = table.Column<int>(type: "int", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Show__6DE3E0B25CC97D35", x => x.ShowId);
                    table.ForeignKey(
                        name: "FK__Show__ShowGenreI__2D27B809",
                        column: x => x.ShowGenreId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowDateTime = table.Column<DateTime>(type: "datetime", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ShowSche__7C6D43B2380E7A80", x => x.ShowScheduleId);
                    table.ForeignKey(
                        name: "FK__ShowSched__HallI__30F848ED",
                        column: x => x.HallId,
                        principalTable: "Hall",
                        principalColumn: "HallId");
                    table.ForeignKey(
                        name: "FK__ShowSched__ShowI__300424B4",
                        column: x => x.ShowId,
                        principalTable: "Show",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfRow = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NumberOfSeat = table.Column<int>(type: "int", nullable: true),
                    isActive = table.Column<bool>(type: "bit", nullable: true),
                    ShowScheduleId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Ticket__712CC6079B969D08", x => x.TicketId);
                    table.ForeignKey(
                        name: "FK__Ticket__Purchase__36B12243",
                        column: x => x.PurchaseId,
                        principalTable: "Purchase",
                        principalColumn: "PurchaseId");
                    table.ForeignKey(
                        name: "FK__Ticket__ShowSche__35BCFE0A",
            ...
            migrationBuilder.InsertData(
                table: "Hall",
                columns: new[] { "HallId", "CreatedAt", "IsDeleted", "ModifiedAt", "Name", "NumberOfSeatsPerRow", "TotalRows", "TotalSeats" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 23, 0, 0, 0, 0, DateTimeKind.Local), false, null, "Mala sala", 10, 10, 100 },
                    { 2, new DateTime(2023, 10, 23, 0, 0, 0, 0, DateTimeKind.Local), false, null, "Velika sala", 15, 10, 150 }
                });
